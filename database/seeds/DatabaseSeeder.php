...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Question::create(['survey_id' => 1, 'step' => 3, 'number' => 5, 'name' => 'pyt5', 'type' => 'checkbox', 'text' =>
            'Z jakiej formy generowania przychodu z bloga/strony/serwisu korzystasz regularnie? <span class="light small">(Zaznacz 3 najważniejsze)</span>', 'values' => json_encode([
            1 => 'sieci afiliacyjne',
        ...
        Question::create(['survey_id' => 1, 'step' => 4, 'number' => 17, 'name' => 'pyt17', 'type' => 'checkbox', 'text' =>
            'Co skłoniłoby Cię do promowania lub zwiększenia działań na rzecz kampanii VIVUS? <span class="text-block light small">(Zaznacz maksymalnie 3)</span>', 'values' => json_encode([
