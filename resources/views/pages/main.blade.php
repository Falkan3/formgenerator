            ...
            <div class="row text-center">
                ...
                @if(isset($survey['step']) && $survey['step']==1)
                    <h3 class="no-margin margin-bottom-medium">Dziękujemy za chęć udziału w ankiecie. Nim przejdziemy do
                        ...
                        prosimy o podanie adresu mailowego, na który prześlemy<span
                                ...
                                class="text-block highlight margin-small">Raport Rynku Afiliacyjnego o wartości 1500 zł</span>
                    </h3>
                @endif
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <section>
                        ...
                        @if(isset($survey['step']) && $survey['step']>1)
                            <h3 class="text-right margin-vertical-medium">
                                <span class="highlight colored">Strona {{($survey['step']-1) . '/' . ($survey['last_step']-1)}}</span>
                            </h3>
                        @endif
